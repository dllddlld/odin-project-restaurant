...
function createMenuPage() {
    ...
    makeMenuItem(
        TEXT.MENU.SURPRISE_ME.TITLE,
        TEXT.MENU.SURPRISE_ME.PRICE,
        TEXT.MENU.SURPRISE_ME.DESCRIPTION,
    );
    makeMenuItem(
        TEXT.MENU.FEED_ME.TITLE,
        TEXT.MENU.FEED_ME.PRICE,
        TEXT.MENU.FEED_ME.DESCRIPTION,
    );
    makeMenuItem(
        TEXT.MENU.DINE_ME.TITLE,
        TEXT.MENU.DINE_ME.PRICE,
        TEXT.MENU.DINE_ME.DESCRIPTION,
    );
    makeMenuItem(
        TEXT.MENU.INDULGE_ME.TITLE,
        TEXT.MENU.INDULGE_ME.PRICE,
        TEXT.MENU.INDULGE_ME.DESCRIPTION,
    );
}
